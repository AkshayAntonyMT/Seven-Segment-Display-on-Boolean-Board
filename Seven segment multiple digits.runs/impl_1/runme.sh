...
HD_PWD='C:/Users/aksha/OneDrive/Desktop/Vivado/Seven Segment Display on Boolean Board/Seven segment multiple digits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sev.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sev.tcl -notrace
